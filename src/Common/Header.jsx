      ...
      <AppBar color="primary" className={classes.colorPrimary}>
        <Toolbar>
          ...
          <IconButton aria-label="Show 17 new notifications" color="inherit" onClick={props.showNotifications}>
            <Badge badgeContent={Object.keys(props.notifications).length} color="secondary">
              <NotificationsIcon />
            </Badge>
          </IconButton>

          <LoginButton attendee={props.attendee}  socket={props.socket} event={props.event} endpoint={props.endpoint}/>
